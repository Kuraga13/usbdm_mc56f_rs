...
/// 
fn get_target_speed(family : BaseRoutineFamily, prog :  &mut Programmer) -> Result<u32, Error>
{
    ...
    let target_bus_frequency:u32 = 
        40 * ((0.5 + (result_header.timing_count as f64) * (routine.calib_frequency as f64) / ( 40.0 * (routine.calib_factor as f64))) as u32);
